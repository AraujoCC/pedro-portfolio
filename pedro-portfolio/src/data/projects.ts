...
export const projects: Project[] = [
  {
    ...
    title: "AgendaPro",
    description:
      "Full stack application designed to simulate a real corporate system for appointment management. REST API with layered architecture and a responsive React dashboard with dark mode.",
    features: [
  ...
  },
  {
    ...
    title: "HayhGang",
    description:
      "Full stack e-commerce platform built from scratch with modern design and real-world architecture. Frontend on Vercel, backend on Render — integrating product management and a responsive shopping UI.",
    features: [
  ...
  },
  {
    ...
    title: "Car Storage",
    description:
      "Full stack vehicle management system simulating a vehicle store. Focused on backend architecture, database integration, object-oriented design, and clean project structure.",
    features: [
