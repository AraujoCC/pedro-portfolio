  ...
  return (
    <div ref={sectionRef} className="section-wrap">
      <div className="section-inner">
          ...
          <div style={{ maxWidth: 820 }}>
            {EXPERIENCE.map((exp, i) => (
              <div key={i} className="ex-card reveal">
                <div>
                  <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", letterSpacing: "0.1em", color: "rgba(255,255,255,0.3)", lineHeight: 1.7, marginBottom: "0.5rem" }}>
                    {exp.dates}
                  </p>
                  <span style={{ display: "inline-block", fontFamily: "var(--font-mono)", fontSize: "0.56rem", letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "rgba(255,255,255,0.38)", border: "1px solid rgba(255,255,255,0.08)", padding: "0.18rem 0.6rem", borderRadius: 2 }}>
                    {exp.badge}
                  </span>
                </div>
                <div>
        ...
        {/* ── DIVIDER ── */}
        <div style={{ height: 1, background: "linear-gradient(90deg, transparent, rgba(255,255,255,0.08), transparent)", margin: "4rem 0" }} />
            ...
            <div key={i} className="ed-card reveal">
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.45rem" }}>
                  {ed.tags.map((tag) => (
                    <span key={tag} style={{ fontFamily: "var(--font-mono)", fontSize: "0.6rem", letterSpacing: "0.07em", color: "rgba(255,255,255,0.3)", border: "1px solid rgba(255,255,255,0.08)", padding: "0.22rem 0.7rem", borderRadius: 2 }}>
                      {tag}
                    </span>
                  ))}
                </div>
